...
import MakesList from './ModelLists/MakesList';
  ...
  return (
    <div className={classes.container}>
      ...
      <form className={classes.selectorMake}>
        ...
        <MakesList setMake={setMake}setModel={setModel}></MakesList> 
      ...
      <form className={classes.selectorYear}>
        ...
        <select name='vehicleYear' ref={selectedRef}onChange={(event) => setYear(event.target.value)}>
          <option value='-'>-</option>
